package de.blutmondgilde.unity.oauth;
...
import static de.blutmondgilde.unity.config.SecurityConfig.DISCORD_BOT_USER_AGENT;
...
public class DiscordOAuth2AccessTokenResponseClient implements OAuth2AccessTokenResponseClient<OAuth2AuthorizationCodeGrantRequest> {
    ...
    public DiscordOAuth2AccessTokenResponseClient(RestOperations restOperations) {
    ...
    public OAuth2AccessTokenResponse getTokenResponse(OAuth2AuthorizationCodeGrantRequest authorizationGrantRequest) {
        ...
        Set<String> scopes = accessResponse.getScopes().isEmpty() ? authorizationGrantRequest.getAuthorizationExchange().getAuthorizationRequest().getScopes() : accessResponse.getScopes();
