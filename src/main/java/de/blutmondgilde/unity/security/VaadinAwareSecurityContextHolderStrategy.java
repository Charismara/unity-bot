...
public class VaadinAwareSecurityContextHolderStrategy implements SecurityContextHolderStrategy {
    ...
    public void setContext(@NonNull SecurityContext securityContext) {
        contextHolder.set(Objects.requireNonNull(securityContext));
    }
